...
pub fn main() -> miette::Result<()> {
    ...
    let main2 = move || {
        ...
        let result = runtime.block_on(Box::pin(main_entry_point()));
...
pub struct Args {
    ...
    #[clap(
        ...
        default_value = "false",
        global = true,
        help_heading = "Output, Prompt, and Flow Control Options"
    )]
    quiet: bool,
}

async fn main_entry_point() -> miette::Result<()> {
    let args = Args::parse();
    ...
    pixi_conda::cli::execute(args.args).await
}
